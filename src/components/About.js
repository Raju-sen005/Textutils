...
export default function About(props) {
  ...
  // const dmMode = () => {
  //   //[jab color black ho ga toh niche di gyi value run ho gi]
  ...
  //   } 
  //   //[jab color white ho ga toh niche di gyi value run ho gi]
  //   else {
  //     setMyStyle({
  //       color: "black",
  //       backgroundColor: "white",
  ...
  return (
    <div className="container" style={{backgroundColor: props.mode === "dark" ? "#212529" : "white", color: props.mode === "dark" ? "white" : "black",}}>
      ...
      {/* <div className="container my-3">
        <button onClick={dmMode} type="button" className="btn btn-primary">
          {btnText}
        </button>
      </div> */}
    </div>
